          ...
          >
            ...
            >
              {displayedChangelog.map((c) => (
                <div key={c.version}>
                  <div
                    style={{ fontSize: 12, fontWeight: 600, color: 'var(--text)', marginBottom: 4 }}
                  >
                    v{c.version}
                  </div>
                  <ul
        ...
        {addon.requires_script && (
          ...
          >
            <div style={{ display: 'flex', gap: 10 }}>
              <LuTriangleAlert
                size={18}
                style={{ color: 'var(--warning, #d98324)', flexShrink: 0, marginTop: 2 }}
              />
            ...
            <div
              style={{ height: 1, background: 'var(--border)', margin: '2px 0', opacity: 0.5 }}
            />
            <label
              style={{
                display: 'flex',
